!(function (e, t) {
          ...
          if (null != (e = arguments[a]))
            for (t in e)
              (i = e[t]),
                "__proto__" !== t &&
                  r !== i &&
                  (l && i && (w.isPlainObject(i) || (o = Array.isArray(i)))
                    ? ((n = r[t]),
                      (s =
                        o && !Array.isArray(n)
                          ? []
  ...
  var k = (function (e) {
    ...
    function ae(e, t, i, o) {
      ...
      if (
        !o &&
        ((t ? t.ownerDocument || t : w) !== h && f(t), (t = t || h), m)
      ) {
        if (11 !== C && (d = Z.exec(e)))
          if ((s = d[1])) {
            if (9 === C) {
    ...
    function Ce(e, t, n, i, o) {
      for (var s, r = [], a = 0, u = e.length, l = null != t; a < u; a++)
        (s = e[a]) && ((n && !n(s, i, o)) || (r.push(s), l && t.push(a)));
      return r;
    }
      ...
      return (
        ...
        le(function (s, r, a, u) {
          var l,
            ...
            v = n ? (o || (s ? e : p || i) ? [] : r) : g;
          if ((n && n(g, v, a, u), i))
            for (l = Ce(v, h), i(l, [], a, u), c = l.length; c--; )
              (d = l[c]) && (v[h[c]] = !(g[h[c]] = d));
          if (s) {
            if (o || e) {
              if (o) {
        ...
        function (e, t) {
          ...
          for (a = e, u = [], l = i.preFilter; a; ) {
            for (r in ((n && !(o = B.exec(a))) ||
              (o && (a = a.slice(o[0].length) || a), u.push((s = []))),
            (n = !1),
            (o = F.exec(a)) &&
              ((n = o.shift()),
            ...
            (g = E(
              ...
              (c = function (e, t, n, r, c) {
                ...
                for (
                  ...
                  if (u && d) {
                    for (
                      p = 0, t || d.ownerDocument === h || (f(d), (n = !m));
                      (g = o[p++]);
                ...
                if (((v += y), a && y !== v)) {
                  ...
                  if (e) {
                    if (0 < v) for (; y--; ) b[y] || x[y] || (x[y] = j.call(r));
                    x = Ce(x);
                  }
                  L.apply(r, x),
                    c &&
      ...
      (u = ae.select =
        function (e, t, n, o) {
          ...
          if (((n = n || []), 1 === h.length)) {
            ...
            for (
              s = G.needsContext.test(e) ? 0 : u.length;
              ...
              if (
                ...
                if ((u.splice(s, 1), !(e = o.length && be(u))))
  ...
  (w.filter = function (e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && $.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  var j,
      ...
      function (e, t) {
        w.fn[e] = function (n, i) {
          ...
          return (
            ...
            1 < this.length &&
              (O[e] || w.uniqueSort(o), L.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
  ...
  (w.Callbacks = function (e) {
    ...
    w.extend({
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
                    ...
                    l = function () {
                      ...
                      if (!(t < s)) {
                        ...
                        (l =
                          ...
                          m(l)
                            ? o
                              ? l.call(e, r(s, n, P, o), r(s, n, M, o))
                              : (s++,
                                l.call(
                                  e,
                                  r(s, n, P, o),
                                  r(s, n, M, o),
                                  r(s, n, P, n.notifyWith)
                                ))
                            : (i !== P && ((a = void 0), (u = [e])),
                              (o || n.resolveWith)(a, u));
                      }
              ...
              return w
                .Deferred(function (e) {
                  n[0][3].add(r(0, e, m(o) ? o : P, e.notifyWith)),
                    n[1][3].add(r(0, e, m(t) ? t : P)),
                    n[2][3].add(r(0, e, m(i) ? i : M));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (q(e, r.done(a(n)).resolve, r.reject, !t),
    ...
    w.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = K.get(s)), 1 === s.nodeType && !V.get(s, "hasDataAttrs"))
          ) {
            for (n = r.length; n--; )
              r[n] &&
                0 === (i = r[n].name).indexOf("data-") &&
                ((i = X(i.slice(5))), ee(s, i, o[i]));
  ...
  function le(e, t, n, i) {
    var o,
      ...
      c =
        ...
        ne.exec(w.css(e, t));
    if (c && c[3] !== l) {
      for (u /= 2, l = l || c[3], c = +u || 1; r--; )
        w.style(e, t, c + l),
          (1 - s) * (1 - (s = a() / u || 0.5)) <= 0 && (r = 0),
          (c /= s);
  ...
  var ce = {};
  function de(e, t) {
    for (var n, i, o, s, r, a, u, l = [], c = 0, d = e.length; c < d; c++)
      (i = e[c]).style &&
        ((n = i.style.display),
        t
          ? ("none" === n &&
              ((l[c] = V.get(i, "display") || null),
              l[c] || (i.style.display = "")),
            "" === i.style.display &&
              ae(i) &&
              (l[c] =
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && _(e, t)) ? w.merge([e], n) : n
    );
  }
  function ve(e, t) {
  ...
  function we(e, t, n, i, o) {
        ...
        if ("object" === b(s)) w.merge(f, s.nodeType ? [s] : s);
          ...
          for (
            r = r || d.appendChild(t.createElement("div")),
              a = (he.exec(s) || ["", ""])[1].toLowerCase(),
              u = me[a] || me._default,
              r.innerHTML = u[1] + w.htmlPrefilter(s) + u[2],
              c = u[0];
            c--;
    ...
    for (d.textContent = "", h = 0; (s = f[h++]); )
      if (i && -1 < w.inArray(s, i)) o && o.push(s);
        ...
        ((l = se(s)), (r = ge(d.appendChild(s), "script")), l && ve(r), n)
      )
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (r.length)
                ...
                (i = n(this, t)),
                this[t](),
                r !== (o = V.get(this, t)) || i ? V.set(this, t, !1) : (o = {}),
                r !== o)
              )
                return (
  ...
  (w.event = {
        ...
        for (l = (t = (t || "").match(z) || [""]).length; l--; )
          if (
            ...
            r &&
              ...
              delete u[h]);
          } else for (h in u) w.event.remove(e, h + t[l], n, i, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          r = w.event.handlers.call(this, a, l), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && _(t, "input") && Ae(t, "click", Se),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && _(t, "input") && Ae(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Pe(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        V.hasData(e) &&
        ((s = V.access(e)), (r = V.set(t, s)), (l = s.events))
      )
        for (o in (delete r.handle, (r.events = {}), l))
          for (n = 0, i = l[o].length; n < i; n++) w.event.add(t, o, l[o][n]);
      K.hasData(e) && ((a = K.access(e)), (u = w.extend({}, a)), K.set(t, u));
    }
  }
  function Me(e, t, n, i) {
    t = r.apply([], t);
    var o,
      ...
      g = t[0],
      v = m(g);
    if (v || (1 < f && "string" == typeof g && !p.checkClone && Ie.test(g)))
    ...
    if (
      ...
      for (u = (a = w.map(ge(o, "script"), Ne)).length; d < f; d++)
        (l = o),
          d !== h &&
            ((l = w.clone(l, !0, !0)), u && w.merge(a, ge(l, "script"))),
          n.call(e[d], l, d);
      if (u)
        for (c = a[a.length - 1].ownerDocument, w.map(a, ze), d = 0; d < u; d++)
          (l = a[d]),
            pe.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : y(l.textContent.replace(Le, ""), l, c));
    }
    return e;
  }
  function qe(e, t, n) {
    for (var i, o = t ? w.filter(t, e) : e, s = 0; null != (i = o[s]); s++)
      n || 1 !== i.nodeType || w.cleanData(ge(i)),
        i.parentNode &&
          (n && se(i) && ve(ge(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (r = ge(c), i = 0, o = (s = ge(e)).length; i < o; i++)
          (a = s[i]),
            "input" === (l = (u = r[i]).nodeName.toLowerCase()) &&
            fe.test(a.type)
              ? (u.checked = a.checked)
              : ("input" !== l && "textarea" !== l) ||
      ...
      if (t)
        if (n)
          for (s = s || ge(e), r = r || ge(c), i = 0, o = s.length; i < o; i++)
            Pe(s[i], r[i]);
        else Pe(e, c);
      return (
        0 < (r = ge(c, "script")).length && ve(r, !d && ge(e, "script")), c
      );
    },
    ...
    w.each(
      ...
      function (e, t) {
        w.fn[e] = function (e) {
          for (var n, i = [], o = w(e), s = o.length - 1, r = 0; r <= s; r++)
  ...
  function et(e, t, n, i, o, s) {
    ...
    for (; r < 4; r += 2)
      "margin" === n && (u += w.css(e, n + ie[r], !0, o)),
        i
          ? ("content" === n && (u -= w.css(e, "padding" + ie[r], !0, o)),
            "margin" !== n &&
              (u -= w.css(e, "border" + ie[r] + "Width", !0, o)))
          : ((u += w.css(e, "padding" + ie[r], !0, o)),
            "padding" !== n
              ? (u += w.css(e, "border" + ie[r] + "Width", !0, o))
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          l = e.style;
        if (
          (u || (t = Ge(a)), (r = w.cssHooks[t] || w.cssHooks[a]), void 0 === n)
        )
  ...
  function ht(e, t, n) {
    ...
    for (
      ...
      if ((i = ht.prefilters[s].call(l, e, c, l.opts)))
        return (
          m(i.stop) &&
        ...
        if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(h))
          ...
          h))
            u ||
              ...
              m && de([e], !0),
              f.done(function () {
                for (i in (m || de([e]), V.remove(e, "fxshow"), h))
                  w.style(e, i, h[i]);
              })),
              (u = ft(m ? g[i] : 0, i, f)),
              i in g ||
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (o in r) r[o] && r[o].stop && ut.test(o) && i(r[o]);
            for (o = s.length; o--; )
              s[o].elem !== this ||
                (null != e && s[o].queue !== e) ||
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, o, s, r;
              if (i)
                for (o = 0, s = w(this), r = xt(e); (t = r[o++]); )
                  s.hasClass(t) ? s.removeClass(t) : s.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = bt(this)) && V.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
    ...
    trigger: function (t, n, o, s) {
      ...
      if (
        ...
        3 !== o.nodeType &&
          ...
          (h = w.event.special[y] || {}),
          s || !h.trigger || !1 !== h.trigger.apply(o, n)))
      ) {
        if (!s && !h.noBubble && !g(o)) {
          for (
            l = h.delegateType || y, Ct.test(l + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (u = a);
        ...
        for (r = 0; (a = v[r++]) && !t.isPropagationStopped(); )
          (p = a),
            ...
            (f = (V.get(a, "events") || {})[t.type] && V.get(a, "handle")) &&
              f.apply(a, n),
            (f = c && a[c]) &&
              f.apply &&
              G(a) &&
  ...
  (Wt.href = kt.href),
    w.extend({
      ...
      ajax: function (t, n) {
        ...
        p.hasContent
          ...
          : ((h = p.url.slice(s.length)),
            p.data &&
              ...
              ((s += (Et.test(s) ? "&" : "?") + p.data), delete p.data),
            !1 === p.cache &&
              ((s = s.replace(Ot, "$1")),
              (h = (Et.test(s) ? "&" : "?") + "_=" + St++ + h)),
            (p.url = s + h)),
        ...
        if (p.beforeSend && (!1 === p.beforeSend.call(m, k, p) || c))
          return k.abort();
        if (
          ((T = "abort"),
          y.add(p.complete),
          ...
          if (((k.readyState = 1), d && g.trigger("ajaxSend", [k, p]), c))
            return k;
          p.async &&
            0 < p.timeout &&
        ...
        function S(t, n, i, a) {
          ...
          c ||
            ...
            i &&
              (x = (function (e, t, n) {
                for (
                  var i, o, s, r, a = e.contents, u = e.dataTypes;
                  "*" === u[0];
            ...
            l
              ? (p.ifModified &&
                  ((C = k.getResponseHeader("Last-Modified")) &&
                    (w.lastModified[s] = C),
                  (C = k.getResponseHeader("etag")) && (w.etag[s] = C)),
                204 === t || "HEAD" === p.type
                  ? (T = "nocontent")
                  : 304 === t
                  ? (T = "notmodified")
                  : ((T = x.state), (f = x.data), (l = !(h = x.error))))
              : ((h = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
            (k.status = t),
            (k.statusText = (n || T) + ""),
            l ? v.resolveWith(m, [f, T, k]) : v.rejectWith(m, [k, T, h]),
            k.statusCode(b),
            (b = void 0),
            d && g.trigger(l ? "ajaxSuccess" : "ajaxError", [k, p, l ? f : h]),
            y.fireWith(m, [k, T]),
            d &&
    ...
    (w.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === l && (e.style.position = "relative"),
          ...
          (s = w.css(e, "top")),
          (u = w.css(e, "left")),
          ("absolute" === l || "fixed" === l) && -1 < (s + u).indexOf("auto")
            ? ((r = (i = c.position()).top), (o = i.left))
            : ((r = parseFloat(s) || 0), (o = parseFloat(u) || 0)),
  ...
  (function (e) {
    ...
    var t = {
      init: function (t) {
        return this.each(function () {
          ...
          var l = 1,
            ...
            p = (n.data({ slideNow: l }), y());
          !(function (t) {
            if (n.hasClass("clb-slider"))
              var o = n.find(
                "> .clb-slider-outer-stage > .clb-slider-stage > .clb-slider-item"
              );
            else {
              n.addClass("clb-slider");
              var a = e(
                  '<div class="clb-slider-outer-stage"><div class="clb-slider-stage"></div><div>'
                ),
                o = n.children().addClass("clb-slider-item");
              if (t.navBtn) {
                var u =
                  '<div class="clb-slider-nav-btn"><div class="prev-btn btn-round btn-round-light ' +
                  t.navBtnClasses +
                  '" tabindex="0"><i class="ion"><svg class="arrow-icon arrow-icon-back" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 7H16M16 7L11 1M16 7L11 13" stroke-width="2"/></svg></i></div><div class="next-btn btn-round btn-round-light ' +
                  t.navBtnClasses +
                  '" tabindex="0"><i class="ion"><svg class="arrow-icon" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 7H16M16 7L11 1M16 7L11 13" stroke-width="2"/></svg></i></div></div>';
                n.append(e(u));
              }
              if (t.verticalScroll) var l = _(o);
              if (t.dots) {
                for (
                  var c = e('<div class="clb-slider-nav-dots"></div>'),
                    d = e(
                      '<div class="clb-slider-dot"><svg width="22px" height="22px" viewBox="0 0 22 22"><g stroke="#17161A" stroke-width="1.2" fill="none" transform="translate(11, 11)"><circle cx="0" cy="0" r="10"></circle></g></svg></div>'
                    ),
                    h = i;
                  0 != h;
                  h--
                  ...
                  d.clone().appendTo(c);
                c.find(".clb-slider-dot:first-child").addClass("active"),
                  n.append(c),
                  (s = n.find("> .clb-slider-nav-dots > .clb-slider-dot"));
              }
              if (t.pagination) {
                for (
                  var p = e('<div class="clb-slider-pagination"></div>'),
                    m = e('<div class="clb-slider-page"></div>'),
                    h = 1;
                  h <= i;
                  h++
                )
                  h < 10
                    ? m
                        .clone()
                        .append(
                          '<span class="clb-slider-pagination-index"> 0' +
                            h +
                            "</span>"
                        )
                        .appendTo(p)
                    : m
                        ...
                        .appendTo(p);
                p.find(".clb-slider-page:first-child").addClass("active"),
                  n.append(p),
                  (r = n.find("> .clb-slider-pagination > .clb-slider-page"));
              }
              if (t.slidesCount) {
                var g = e(
                    '<div class="clb-slider-count"><div class="clb-slider-count-current"></div><div class="clb-slider-count-total">' +
                      i +
                      "</div></div>"
                  ),
                ...
                n.append(g);
                for (
                  var y = n.find(".clb-slider-count-current"), h = 1;
                  h <= i;
                  h++
                )
                  v.clone()
                ...
                v
                  .clone()
                  .append(
                    '<span class="clb-slider-pagination-index">' + i + "</span>"
                  )
                  .prependTo(y),
                  v
                    .clone()
                    .append(
                      '<span class="clb-slider-pagination-index">1</span>'
                    )
                    .appendTo(y),
                  (f = n.find(".clb-slider-count-number").height());
            ...
            t.loop ||
              (o.slice(0, t.items).addClass("active"),
              e(o[0 + t.items]).addClass("next-slide"));
            if (t.verticalScroll) {
              var x = n.width(),
                w = (x * i) / t.items + (t.gap / t.items) * i;
              n.find("> .clb-slider-stage").css({ width: w + "px" });
              var C = n.height(),
                T = (C * i) / t.items + (t.gap / t.items) * i;
              o.css("height", l + "px"),
                o.css("margin-right", t.gap + "px"),
                n.css("height", l);
              var C = o.height();
          ...
          var m,
            g = n.find(" > .clb-slider-outer-stage > .clb-slider-stage"),
            v = g.find(" > .clb-slider-item");
          function y() {
            var n = e.extend(h, t);
            return (
              h.responsive &&
                e(h.responsive).each(function (i) {
                  for (var o in e(this)[i])
                    if (e(window).width() <= o)
                      return (n = e.extend(h, t.responsive[o]));
                }),
              n
            );
          }
          function b(t, n, s, r, u, c) {
            t.trigger("clb-slider.change").trigger("clb-slider.next-change"),
              ((n.loop && l != i - a) || l < a) &&
                (r.removeClass("active prev-slide next-slide"),
                s.css({ transition: "1s" }),
                n.loop && ++l,
                n.loop
                  ? (n.dots || n.pagination) && S(l - a)
                  : (n.dots || n.pagination) && S(l),
                r.slice(l, l + n.items).addClass("active"),
                e(r[l - 1]).addClass("prev-slide"),
                e(r[l + n.items]).addClass("next-slide"),
                (d = n.verticalScroll
                  ? (-t.height() / n.items) * l - (n.gap / n.items) * l
                  : (-t.width() / n.items) * l - (n.gap / n.items) * l),
                E(),
                n.loop || l++,
                n.loop && l - n.items,
                l == i - a &&
                  n.loop &&
                  (r.slice(a, a + n.items).addClass("active"),
                  1,
                  setTimeout(function () {
                    t
                      .find(
                        "> .clb-slider-outer-stage > .clb-slider-stage > .cloned"
                      )
                      .removeClass("active"),
                      e(r[(l = a)]).addClass("active"),
                      (d = n.verticalScroll
                        ? (-t.height() / n.items) * l - (n.gap / n.items) * l
                        : (-t.width() / n.items) * l - (n.gap / n.items) * l),
                      E(),
          ...
          function x(t, n, s, r, u, c) {
            t.trigger("clb-slider.change").trigger("clb-slider.prev-change"),
              ((n.loop && l != a - n.items) || l > 1) &&
                (s.css({ transition: "1s" }),
                n.loop || --l - 1,
                (d = n.verticalScroll
                  ? (-t.height() / n.items) * (l - 1) -
                    (n.gap / n.items) * l +
                    +n.gap / n.items
                  : (-t.width() / n.items) * (l - 1) -
                    (n.gap / n.items) * l +
                ...
                n.loop && --l - 1,
                n.loop
                  ? ((n.dots || n.pagination) && S(l - a < 0 ? l : l - a),
                    r.removeClass("active prev-slide next-slide"),
                    r.slice(l, l + n.items).addClass("active"),
                    e(r[l - 2]).addClass("prev-slide"),
                    e(r[l + n.items]).addClass("next-slide"))
                  : ((n.dots || n.pagination) && S(l - 1),
                    r.removeClass("active prev-slide next-slide"),
                    r.slice(l - 1, l + n.items - 1).addClass("active"),
                    e(r[l - 2]).addClass("prev-slide"),
                    e(r[l + n.items - 1]).addClass("next-slide")),
                l == a - n.items &&
                  n.loop &&
                  (r
                    .slice(2 * a - n.items, 2 * a - n.items + n.items)
                    .addClass("active"),
                  i - n.items - 1,
                  setTimeout(function () {
                    t
          ...
          function C(e) {
            var t = _(
              e.find(
                " > .clb-slider-outer-stage > .clb-slider-stage > .clb-slider-item.active"
              )
            );
            ...
            t.css({ transition: ".3s" }),
              p.loop
                ? (o = e - a + 1) == i.length
                  ...
                  : o > a
                  ? setTimeout(function () {
                      (o = 1), t.css({ transition: "none" }), s();
                    }, 300)
                  : 0 == o &&
                    setTimeout(function () {
                      (o = a), t.css({ transition: "none" }), s();
                    }, 300)
                : (o = e - 1),
              s();
          }
          function k() {
            if (n.hasClass("clb-slider-scroll-bar")) {
              let t = p.loop ? l - a + 1 : l,
                n = (100 / a) * t;
              n > 100 && (n = 100), e(".scroll-track").css("width", n + "%");
            }
          }
          function S(t) {
            s && (s.removeClass("active"), e(s[t]).addClass("active")),
              r && (r.removeClass("active"), e(r[t]).addClass("active"));
          }
          function E() {
            u && (d *= -1),
              p.verticalScroll
          ...
          function $() {
            g.css({ transition: "none" }), (l -= 1);
            var t = y();
            if (
              ((d = t.verticalScroll
                ? (-n.height() / t.items) * l - (t.gap / t.items) * l
                : (-n.width() / t.items) * l - (t.gap / t.items) * l),
              E(),
              v.removeClass("active"),
              v.slice(l, l + t.items).addClass("active"),
              e(v[l - 1]).addClass("prev-slide"),
              e(v[l + t.items]).addClass("next-slide"),
              t.verticalScroll)
            ) {
              var o = ((u = n.width()) * i) / t.items + (t.gap / t.items) * i;
              n.find("> .clb-slider-stage").css({ width: o + "px" });
              var s = (a = n.height()) / t.items - t.gap + t.gap / t.items,
                r = (a * i) / t.items + (t.gap / t.items) * i;
              v.css("height", s + "px"),
                v.css("margin-right", t.gap + "px"),
                n.css("height", s);
              var a = v.height();
              n.find("> .clb-slider-stage").css({
                height: r + "px",
              ...
              var u,
                c = (u = n.width()) / t.items - t.gap + t.gap / t.items;
              o = (u * i) / t.items + (t.gap / t.items) * i;
              v.css("min-width", c + "px"), v.css("margin-right", t.gap + "px");
              a = v.height();
              n.find("> .clb-slider-stage").css({ width: o + "px" });
            }
            t.loop
              ? (t.dots || t.pagination) && S(l - t.items)
              : (t.dots || t.pagination) && S(l),
              l++;
          }
          function _(t) {
            var n = 0;
          ...
          !(function () {
            p.loop &&
              (g.find(" > .cloned").length ||
                (e(v).clone().addClass("cloned").appendTo(g),
                e(v).clone().addClass("cloned").prependTo(g)),
              (v = g.find(" > .clb-slider-item")),
              (l = a),
              (i = v.length),
              v.slice(l, l + p.items).addClass("active"),
              (d = p.verticalScroll
                ? (-n.height() / p.items) * l - (p.gap / p.items) * l
                : (-n.width() / p.items) * l - (p.gap / p.items) * l),
              E(),
              e(v[l - 1]).addClass("prev-slide"),
              e(v[l + p.items]).addClass("next-slide"));
            !0 === p.mousewheel &&
              (function (t, n, o, a) {
                ...
                t.on("wheel mousewheel", function (c) {
                  ...
                  if (
                    ...
                    return !1;
                  d > 0 && l < i
                    ? (b(t, n, o, a, s, r), (u = !1), c.preventDefault())
                    : d < 0 &&
                      l > 1 &&
                      (x(t, n, o, a, s, r), (u = !1), c.preventDefault()),
                    setTimeout(function () {
                      u = !0;
                    }, f);
                });
            ...
            !0 === p.drag &&
              (function (t, n, i, o) {
                ...
                e(i).on("mousedown touchstart", function (l) {
                  var c = l.clientX;
                  "touchstart" == l.type &&
                    (c = l.originalEvent.touches[0].pageX),
                    e(i).on("mousemove touchmove", function (l) {
                      if (1 == a) {
                        var d = l.pageX;
                        "touchmove" == l.type &&
                          ((d = l.originalEvent.touches[0].pageX), (u = 10)),
                          d + u < c
                            ? (b(t, n, i, o, s, r),
                              (c = l.clientX),
                              (a = !1),
            ...
            if (!0 === p.pagination) {
              var u = n.find(".clb-slider-dot, .clb-slider-page");
              w(n, p, u);
            }
            p.verticalScroll && n.addClass("clb-slider-vertical");
            !0 === p.navBtn &&
              (n
                .find("> .clb-slider-nav-btn .next-btn")
                .on("click", function () {
                  b(n, p, g, v, s, r);
                }),
              n
                .find("> .clb-slider-nav-btn .prev-btn")
                .on("click", function () {
                  x(n, p, g, v, s, r);
                }));
            !1 !== p.startSlide &&
              ...
              v.slice(l, +l + p.items).addClass("active"),
              (d = p.verticalScroll
                ? (-n.height() / p.items) * l - p.gap / i - p.gap / 2
                : (-n.width() / p.items) * l - p.gap / i - p.gap / 2),
              E(),
              l++);
            e(window).on("keydown", function (e) {
              ...
              !0 === p.autoHeight &&
                n.on("clb-slider.changed", function () {
                  C(n);
                });
            o && k();
            n.on("to-slide", function (e, t) {
              ...
              n.on("executeAutoHeight", function () {
                C(n);
              });
          })();
          var A = !1,
      ...
      destroy: function () {
        return this.each(function () {
          ...
          t.removeClass("clb-slider"),
            n.unwrap(),
            n.removeAttr("style").removeClass("clb-slider-item active");
        });
      },
    };
    jQuery.fn.clbSlider = function (n) {
      return t[n]
        ...
        : "object" != typeof n && n
        ? void e.error("Method with name " + n + " doesn't exist")
  ...
  (function (e, t) {
    ...
    function i(i) {
      if (
        ...
        for (
          var l = (u.isBorderBox = "border-box" == s.boxSizing), c = 0;
          c < a;
          c++
        ) {
          var d = r[c],
        ...
        var C = e(s.height);
        return (
          !1 !== C && (u.height = C + (x ? 0 : m + b)),
          (u.innerWidth = u.width - (p + y)),
        ...
        n.docReady(function () {
          ...
          l.forEach(function (e) {
            ...
            try {
              ...
              return void (
                o &&
                o.error("Error parsing " + r + " on " + e.className + ": " + t)
              );
            }
            var a = new t(e, n);
            d && d.data(e, i, a);
  ...
  (function (e, t) {
    ...
    (c._create = function () {
      ...
      (c._filter = function (e) {
        ...
        t = t || "*";
        for (
          var n = [], i = [], o = [], s = this._getFilterTest(t), r = 0;
          r < e.length;
          r++
        ) {
          var a = e[r];
  ...
  (function (e, t, n) {
    ...
    (C.prototype =
      ...
      (y =
        ...
        !!t.hasOwnProperty("ontouchstart")),
      (i = function (t) {
        return e(t)
          .closest(":data(plugin_" + b + ")")
          .data("plugin_" + b);
      }),
      (o = function (t) {
        t = e(t);
        var n = this.settings;
        t.attr("id") ||
          t.attr("id", n.uuidPrefix + "-" + new Date().getTime() + "-" + ++g);
      }),
      (s = function (t, i) {
        var o,
          s = e(t.target),
        ...
        if (
          ...
          if (
            (c = l
              .find("." + u.topNavItemClass + " ." + u.openClass + ":first")
              .closest("." + u.topNavItemClass)).is(t.relatedTarget) ||
            c.has(t.relatedTarget).length > 0
          )
            0 === c.length &&
              l
                .find("[aria-expanded=true]")
                .attr("aria-expanded", "false")
                .removeClass(u.openClass)
                .filter("." + u.panelClass)
                .attr("aria-hidden", "true");
          else {
            if (
              ("mouseout" === t.type || "focusout" === t.type) &&
              c.has(n.activeElement).length > 0
            )
              return;
            c
              .find("[aria-expanded]")
              ...
              .filter("." + u.panelClass)
              .attr("aria-hidden", "true"),
              (("keydown" === t.type && t.keyCode === w.ESCAPE) ||
                "DOMAttrModified" === t.type) &&
                ((o = c.find(":tabbable:first")),
                setTimeout(function () {
                  l
                    .find("[aria-expanded]." + r.settings.panelClass)
                    .off("DOMAttrModified.accessible-megamenu"),
                    o.focus(),
                    (r.justFocused = !1);
                }, 99));
          ...
          clearTimeout(r.focusTimeoutID),
            ...
            jQuery(this.element).trigger(
              "megamenu:open",
              c.find("[aria-expanded]")
            ),
            "mouseover" === t.type &&
              s.is(":tabbable") &&
              1 === c.length &&
              0 === d.length &&
              l.has(n.activeElement).length > 0 &&
              (s.focus(), (r.justFocused = !1)),
            m.call(r);
      }),
      (r = function (t) {
        var n = e(t.target),
        ...
        1 === i.length &&
          0 === o.length &&
          1 === i.find("." + this.settings.panelClass).length &&
          (n.hasClass(this.settings.openClass)
            ? this.justFocused
              ? (t.preventDefault(),
                t.stopPropagation(),
                (this.justFocused = !1))
              : y &&
                (t.preventDefault(),
                t.stopPropagation(),
                s.call(this, t, n.hasClass(this.settings.openClass)))
            : (t.preventDefault(), t.stopPropagation(), s.call(this, t)));
      }),
      (a = function (t) {
        0 === this.menu.has(e(t.target)).length &&
          (t.preventDefault(), t.stopPropagation(), s.call(this, t, !0));
      }),
      (u = function (t) {
      ...
      (l = function (t) {
        clearTimeout(this.focusTimeoutID),
          e(t.target)
            ...
            .on("click.accessible-megamenu", e.proxy(r, this)),
          (this.justFocused = !0),
          this.panels.filter("." + this.settings.openClass).length &&
            s.call(this, t);
      }),
      (c = function (n) {
        this.justFocused = !1;
        ...
        o
          ...
          .off("click.accessible-megamenu", r),
          t.cvox
            ? (i.focusTimeoutID = setTimeout(function () {
                t.cvox.Api.getCurrentNode(function (e) {
                  a.has(e).length
                    ? clearTimeout(i.focusTimeoutID)
                    : (i.focusTimeoutID = setTimeout(
                        function (e, t, n) {
                          s.call(e, t, n);
                        },
                        275,
      ...
      (d = function (n) {
        var o,
          ...
          c,
          d,
          f = e(e(this).is(".hover:tabbable") ? this : n.target),
        ...
        switch (
            ...
            n.preventDefault(),
              $
                ? (s.call(h, n),
                  (S =
                    1 ===
                    y.find("." + p.panelClass + " :tabbable:first").focus()
                      .length))
                : (S =
                    1 ===
                    b.filter(":gt(" + b.index(f) + "):first").focus().length),
              !S &&
                t.opera &&
                "[object Opera]" === opera.toString() &&
                (n.ctrlKey || n.metaKey) &&
                ((u = (b = e(":tabbable")).index(f)),
                (S =
                  1 ===
                  e(
                    ":tabbable:gt(" + e(":tabbable").index(f) + "):first"
                  ).focus().length));
            break;
          case w.UP:
            n.preventDefault(),
              $ && f.hasClass(p.openClass)
                ? (s.call(h, n, !0),
                  (o = g.filter(":lt(" + g.index(y) + "):last")).children(
                    "." + p.panelClass
                  ).length &&
                    ((S =
                      1 ===
                ...
                : $ ||
                  (S =
                    1 ===
                    b.filter(":lt(" + b.index(f) + "):last").focus().length),
              !S &&
                t.opera &&
                "[object Opera]" === opera.toString() &&
                (n.ctrlKey || n.metaKey) &&
                ...
                (S =
                  1 ===
                  e(
                    ":tabbable:lt(" + e(":tabbable").index(f) + "):first"
                  ).focus().length));
            break;
          case w.RIGHT:
            n.preventDefault(),
              $
                ...
                : (C.length &&
                    ...
                    (S =
                      1 ===
                      C.filter(":gt(" + C.index(T) + "):first")
                        .find(":tabbable:first")
                        .focus().length),
                  S || (S = 1 === y.find(":tabbable:first").focus().length));
            break;
          case w.LEFT:
            n.preventDefault(),
              $
          ...
          case w.TAB:
            (u = b.index(f)),
              n.shiftKey && $ && f.hasClass(p.openClass)
                ? (s(n, !0),
                  (o = g.filter(":lt(" + g.index(y) + "):last")).children(
                    "." + p.panelClass
                  ).length &&
                ...
                : n.shiftKey && u > 0
                ? (S = 1 === b.filter(":lt(" + u + "):last").focus().length)
                : !n.shiftKey && u < b.length - 1
                ? (S = 1 === b.filter(":gt(" + u + "):first").focus().length)
                : t.opera &&
                  "[object Opera]" === opera.toString() &&
                  ((u = (b = e(":tabbable")).index(f)),
                  (S = n.shiftKey
                    ? 1 ===
                      e(
                        ":tabbable:lt(" + e(":tabbable").index(f) + "):last"
                      ).focus().length
                    : 1 ===
                      e(
                        ":tabbable:gt(" + e(":tabbable").index(f) + "):first"
          ...
          default:
            ...
            for (
              this.keydownTimeoutID = setTimeout(function () {
                ...
                b =
                  $ && !f.hasClass(p.openClass)
                    ? b.filter("." + p.topNavItemClass + " > :tabbable")
                    : y.find(":tabbable"),
      ...
      (h = function (t) {
        clearTimeout(this.mouseTimeoutID),
          ...
          e(t.target).is(":tabbable") &&
            e("html").on("keydown.accessible-megamenu", e.proxy(d, t.target));
      }),
      (p = function (t) {
        var n = this;
      ...
      (m = function (t) {
        ...
        t
          ? (e("html").off(
            ...
            n
              .find("[aria-expanded]." + this.settings.panelClass)
              .off("DOMAttrModified.accessible-megamenu", u))
          : (e("html").on(
              "mouseup.outside-accessible-megamenu, touchend.outside-accessible-megamenu, mspointerup.outside-accessible-megamenu,  pointerup.outside-accessible-megamenu",
              e.proxy(a, this)
            ),
            n
              ...
              .on("DOMAttrModified.accessible-megamenu", e.proxy(u, this)));
      }),
      {
        constructor: C,
        init: function () {
          ...
          i.attr("role", "navigation"),
            s.addClass(n.menuClass),
            a.each(function (i, s) {
              var r, a;
              (s = e(s)).addClass(n.topNavItemClass),
                (r = s.find(":tabbable:first")),
                ...
                a.length &&
                  ...
                  a
                    ...
                    .addClass(n.panelClass)
                    .not("[aria-labelledby]")
                    .attr("aria-labelledby", r.attr("id")));
            }),
            (this.panels = s.find("." + n.panelClass)),
            s
              .on(
                "focusin.accessible-megamenu",
                ":tabbable, :focusable, ." + n.panelClass,
                e.proxy(l, this)
              )
              .on(
              ...
              .on("keydown.accessible-megamenu", e.proxy(d, this))
              .on("mouseover.accessible-megamenu", e.proxy(h, this))
              .on("mouseout.accessible-megamenu", e.proxy(p, this))
              .on("mousedown.accessible-megamenu", e.proxy(f, this)),
            y && s.on("touchstart.accessible-megamenu", e.proxy(r, this)),
      ...
      (e.fn[b] = function (t) {
        return this.each(function () {
          e.data(this, "plugin_" + b) ||
            e.data(this, "plugin_" + b, new C(this, t));
        });
      }),
      e.extend(e.expr[":"], {
          ...
          v = function () {
            return (
              !(arguments.length <= 0 || void 0 === arguments[0]) &&
                ...
                (p = !0),
              p
                ? ((h = (0, d.default)(h, g)), (0, c.default)(h, g.once), h)
                : void 0
            );
          },
          y = function () {
      ...
      function (e, t, n) {
        ...
        e.exports = function (e, t, n) {
          ...
          return (
            ...
            s(e, t, { leading: o, maxWait: t, trailing: a })
          );
        };
      },
      function (e, t) {
        ...
        e.exports = function (e, t, i) {
          ...
          return (
            ...
            n(i) &&
              ((w = !!i.leading),
              (h = (C = "maxWait" in i) ? v(o(i.maxWait) || 0, t) : h),
      ...
      function (e, t) {
        ...
        function n() {
          for (var e, t, n = 0, o = s.length; o > n; n++) {
            e = s[n];
            for (
              var r, a = 0, u = (t = i.querySelectorAll(e.selector)).length;
              u > a;
              a++
            )
              (r = t[a]).ready || ((r.ready = !0), e.fn.call(r, r));
          }
        }
        Object.defineProperty(t, "__esModule", { value: !0 });
        ...
        t.default = function (e, t) {
          s.push({ selector: e, fn: t }),
            !r &&
              o &&
              (r = new o(n)).observe(i.documentElement, {
                childList: !0,
                subtree: !0,
                removedNodes: !0,
              }),
        ...
        t.default = function (e) {
          for (
            ...
            (t += e.offsetLeft - ("BODY" != e.tagName ? e.scrollLeft : 0)),
              (n +=
                e.offsetTop +
                new CSSMatrix(window.getComputedStyle(e).transform).m42 -
  ...
  $(function () {
    ...
    function t() {
      $("[data-parallax-bg]").each(function () {
        ...
        "vertical" == $(this).attr("data-parallax-bg")
          ? $(this)
              .find(".parallax-bg")
              .css({ height: $(this).outerHeight() + 200 * t + "px" })
          : $(this)
              .find(".parallax-bg")
              .css({ width: $(this).outerWidth() + 200 * t + "px" }),
          e.addClass(
            "vertical" == $(this).attr("data-parallax-bg") ? "" : "horizontal"
          );
      });
    }
    function n() {
      ...
      function n(e, t, n, i, o, s) {
        if (t <= i + o && t + n + s >= i) {
          var r = 100 * parseFloat(e.attr("data-parallax-speed")),
            ...
            u = -2 * ((-t + i + o) / (n + o)) * r;
          "vertical" == e.attr("data-parallax-bg")
            ? a.css("transform", "translate3d(0, " + u + "px, 0)")
            : a.css("transform", "translate3d(" + u + "px, 0, 0)");
        }
      }
      $("[data-parallax-bg]").each(function () {
    ...
    function o(e, t) {
      ...
      n + i > t - i &&
        n + i < t - i + 300 &&
        (e.find(".clb-slider-outer-stage").css({ height: "inherit" }),
    ...
    function r() {
      var e,
        t = $(".clb__dark_section, .clb__light_section");
      if (t.length) {
          ...
          !(function (s) {
            ...
            t.each(function () {
              var t = $(this).offset().top,
                s = $(this);
              if (
                (s.hasClass("clb__dark_section")
                  ? (e = "light-typo")
                  : s.hasClass("clb__light_section") && (e = "dark-typo"),
                t + s.outerHeight() > r && r > t)
              )
                return n.addClass(e), i.addClass(e), o.addClass(e), !1;
    ...
    function l(e) {
      setTimeout(function () {
        e.removeClass("visible"),
          e.find(".clb-popup-holder").empty(),
          e
            .find(".clb-popup-holder")
            .removeClass()
            .addClass("clb-popup-holder");
      }, 200);
    }
    function c() {
      ...
      $(e).each(function (e) {
        ...
        var i = {
          ...
          updatePosition: function (e) {
            ...
            !(function (e) {
              if (e.parents(".clb-slider-item").hasClass("clb-slider-item"))
                return !0;
            })($(n))
              ? ((this.x = t.pageX - this._x),
                (this.y = -1 * (t.pageY - this._y)))
              : ((this.x =
                  t.pageX -
                  (Math.floor($(n).width() / 2) + $(n).offset().left)),
                (this.y =
                  -1 *
                  (t.pageY -
                    (Math.floor($(n).height() / 2) + $(n).offset().top))));
          },
          setOrigin: function (e) {
            (this._x = Math.floor($(e).width() / 2) + $(n).offset().left),
              (this._y = Math.floor($(e).height() / 2) + $(n).offset().top);
          },
          show: function () {
        ...
        var o = 0,
          s = function (e) {
            i.updatePosition(e),
              r(
                (i.y / t.offsetHeight / 2).toFixed(2),
                (i.x / t.offsetWidth / 2).toFixed(2)
              );
          },
          r = function (e, n) {
    ...
    s.find(".title").click(function (e) {
      ...
      (function () {
        var e = 0;
        (megaMenu = $("#masthead #mega-menu-wrap")),
          $(".clb-hamburger").on("click", function () {
            u(".main-nav .mbl-overlay");
          }),
          $(
            '.clb-close, .mbl-overlay-bg, .mobile-header #site-navigation a[href^="#"]'
          ).on("click", function () {
            $("#mega-menu-sub-" + e).removeClass("active"),
              $("#mega-menu-sub-" + e).removeAttr("id"),
              e--,
              $("#site-navigation").removeClass("active"),
              $(".close-menu").css("right", "-100%"),
              $(".clb-hamburger").removeClass("hidden"),
              $("#masthead .search").removeClass("visible"),
              $(window).width() <= 1024 && l($(".main-nav .mbl-overlay"));
          }),
          $(window).width() <= 1024 &&
            $(document).on("keydown", function (e) {
              27 == e.keyCode && l($(".main-nav .mbl-overlay"));
            }),
          ...
          $(".has-submenu > a").on("click touchend", function (t) {
            if ($(window).width() <= 1024) {
              var r = $(this).parent(),
                ...
                u = r.find(
                  ">.sub-nav >.sub-menu, >.sub-sub-nav >.sub-sub-menu"
                );
              if (
                r.hasClass("menu-item-depth-0") &&
                !r.hasClass("active-main-item")
              )
                $(
                  ".sub-nav >.sub-menu, .sub-sub-nav >.sub-sub-menu"
                ).removeAttr("style"),
                  $(".active-main-item")
                    .find(".sub-menu.active, .sub-sub-menu.active")
                    .removeClass("active"),
                  $(".active-main-item").removeClass("active-main-item active"),
                  r.addClass("active-main-item");
              else if (r.hasClass("active-main-item")) return i(), !1;
              if (
                (e > 0 && o(),
                $(this).hasClass("active") || r.hasClass("active"))
              )
                return (
                  s(r),
                  n(),
                  r.hasClass("menu-item-depth-" + e) || e--,
          ...
          $("#mega-menu-wrap").length &&
            ($("#mega-menu-wrap")
              ...
              .on("megamenu:open", function (e, t) {
                $(this);
                var n,
                  i = $(t);
                if ($(window).width() <= 768) return !1;
                if (
                  i.is(".main-menu-link.visible") &&
                  i.siblings("div.sub-nav").length > 0
                )
                  n = i.siblings("div.sub-nav");
                else {
                  if (!i.is("div.sub-nav")) return !0;
                  i = (n = i).siblings(".main-menu-link");
                }
                var o = n.find("ul.sub-menu-wide");
                o.each(function () {
                  var e = $(this),
                    t = 1;
                ...
                if ($("#masthead.header-2").length) {
                  var r = $("#masthead.header-2 .header-wrap");
                  s = $(window).width() - r.outerWidth() - r.offset().left;
                }
                var a = $(window).width(),
                  u = n.find("> ul").width(),
                  l = 0;
                n.css({ "max-width": a }),
                  u > a && (n.addClass("sub-nav-onecol"), (u = n.width()));
                var c = i.outerWidth(),
                  d = i.offset().left,
                  f = a - i.offset().left - c;
                d < 0 && (l = -(d - u / 2 + c / 2) - s),
        ...
        t.length &&
          ...
          $(document).on("mouseup touchstart", function (e) {
            0 === t.has(e.target).length &&
              ($(
                ".sub-nav > ul > li, .sub-nav .mega-menu-item > .sub-sub-nav > .sub-sub-menu > li"
              ).removeClass("showed active showed-onclick"),
          ...
          t
            ...
            .on("megamenu:open", function (n, r) {
              $(this)
                .find(
                  ".sub-nav:not(.visible) > ul > li, .sub-nav .mega-menu-item:not(:hover) > .sub-sub-nav > .sub-sub-menu > li"
                )
                .removeClass("showed active"),
                !$(window).width() >= 1024 &&
                  $(this)
                    .find(
                      ".sub-nav.visible > ul > li, .sub-nav .mega-menu-item:hover > .sub-sub-nav > .sub-sub-menu > li"
                    )
                    .each(function (e) {
                      var t = $(this);
                      setTimeout(function () {
                        t.parent().parent().parent().is(":hover") &&
                          t.addClass("showed");
                      }, 40 * e);
                    }),
                t.parents(".clb-hamburger-nav").hasClass("centered") &&
                  !$(window).width() >= 1024 &&
                  $(".has-submenu > a .has-submenu-icon").on(
                    "click",
                    function () {
                      var t = $(this).parent().parent();
                      return (
                        t.hasClass("menu-item-depth-0") &&
                          !t.hasClass("active") &&
                          (i(), t.addClass("active-main-item")),
                        t.hasClass("menu-item-depth-" + e) || e++,
                        t.hasClass("menu-item-depth-" + e) &&
                          !t.hasClass("active") &&
                          o(),
                        s(t),
                        t.addClass("active"),
                        t
                          .find("> .sub-nav, > .sub-sub-nav")
                          .addClass("open-onclick"),
                        $(".open-onclick")
                          .find(
                            "> .sub-menu > .mega-menu-item, > .sub-sub-menu > .mega-menu-item "
                          )
                          .addClass("showed-onclick"),
                        !1
                      );
                    }
                  ),
                $(window).width() <= 1024 &&
                  $(".has-submenu > a").on("click touchend", function (t) {
                    var n = $(this).parent();
                    n.hasClass("menu-item-depth-0") &&
                      !n.hasClass("active") &&
                      i(),
                      n.hasClass("menu-item-depth-" + e) || e++,
                      n.hasClass("menu-item-depth-" + e) &&
                        !n.hasClass("active") &&
                        o(),
                      n.addClass("active"),
                      $(this).hasClass("showed") ||
                        ($(
                          ".sub-sub-nav .sub-sub-menu .sub-nav-item"
                        ).removeClass("showed"),
                        $(".sub-sub-nav .sub-sub-menu").removeClass("visible")),
                      n.addClass("active"),
                      n
                        .find(
                          "> .sub-nav > .sub-menu > .sub-nav-item, > .sub-sub-nav > .sub-sub-menu > .sub-nav-item"
                        )
                        .addClass("showed"),
                      n
                        .find("> .sub-sub-nav > .sub-sub-menu")
                        .addClass("visible");
                  });
            }),
          t.parents(".clb-hamburger-nav").hasClass("centered") &&
            $(window).width() >= 1024 &&
            $(".clb-hamburger-nav-holder .sub-nav").on(
              "mouseleave",
              function () {
        ...
        function i() {
          (e = 0),
            $(
              ".sub-nav > ul.sub-menu, .sub-sub-nav > ul.sub-sub-menu, .submenu, .sub-nav-item"
            ).removeClass("active showed"),
            $(".nav-item").removeClass("active active-main-item"),
            $(".sub-nav, .sub-sub-nav").removeClass("open-onclick"),
            $(".sub-nav >.sub-menu, .sub-sub-nav >.sub-sub-menu").removeAttr(
              "style"
            );
        }
        function o(t) {
          ...
          n.removeClass("active"),
            n
              ...
              .removeClass("active showed-onclick"),
            n.find(".sub-nav, .sub-sub-nav").removeClass("open-onclick "),
            n
              .find(".sub-nav >.sub-menu, .sub-sub-nav >.sub-sub-menu")
              .removeAttr("style");
        }
        function s(e) {
          e.hasClass("active-main-item") && i(),
            e.find(".sub-menu, .sub-sub-menu").removeAttr("style");
        }
      })(),
      ...
      $(window).on("load", function () {
        ...
        e(),
          ...
          $(".carousel").each(function () {
            ...
            $(window).on("scroll", function () {
              ...
              t.find(".clb-slider-nav-btn .btn-round").on("click", function () {
                $(this).hasClass("next-btn")
                  ? e.trigger("next-slide")
                  : e.trigger("prev-slide");
              });
          }),
          ...
          (s = $("[data-isotope-grid]")),
          (f = $(".demo-filter")),
          (h = f.offset().top + f.outerHeight()),
          (p =
            $(".demo-section").offset().top +
            $(".demo-section").height() -
            $(window).height()),
          s.isotope({ percentPosition: !0 }),
          f.find("a").on("click", function () {
            return (
              f.find(".active").removeClass("active"),
              $(this).addClass("active"),
              s.isotope && s.isotope({ filter: $(this).attr("data-filter") }),
              setTimeout(function () {
          ...
          $(window).on("scroll", function (e) {
            ...
            t > h && t < p
              ...
              : t < h
              ? (f.removeClass("showed"), f.removeClass("fixed"))
              : t > p &&
                (f.css({ transform: "translateY(100%)" }),
                setTimeout(function () {
          ...
          window.location.hash &&
            f.find('a[href="' + window.location.hash + '"]').trigger("click"),
          r(),
          (m = $("body").outerWidth()),
          $("body").offset().left,
          (g = function (e, t, n, i) {
            ...
            (o = n ? o.last() : o.eq(0)).css({
              ...
              o.length &&
                (n
                  ? o.css("min-width", m - o.offset().left + "px")
                  : o.css({
                      position: "relative",
                      left: -o.offset().left + "px",
                      "min-width": o.offset().left + o.outerWidth() + "px",
                    }),
                $(window).width() <= 768 && o.css({ width: "", left: "" }),
            ...
            if ($("body").hasClass("custom-cursor")) {
              ...
              (window.onmousemove = function (s) {
                ...
                $("body").on(
                  ...
                  "a, .cursor-as-pointer",
                  function () {
                    e.classList.add("cursor-link-hover"),
                      t.classList.add("cursor-link-hover");
                  }
                ),
                $("body").on(
                  "mouseleave",
                  ...
                  function () {
                    ($(this).is("a") &&
                      ...
                      (e.classList.remove("cursor-link-hover"),
                      t.classList.remove("cursor-link-hover"));
                  }
                ),
                $("body").on("mouseenter", "[data-cursor-class]", function () {
                  const n = $(this).attr("data-cursor-class");
                  -1 != n.indexOf("dark-color") &&
                    (e.classList.add("dark-color"),
                    t.classList.add("dark-color")),
                    -1 != n.indexOf("cursor-link") &&
                ...
                $("body").on("mouseleave", "[data-cursor-class]", function () {
                  ...
                  -1 != n.indexOf("dark-color") &&
                    ...
                    t.classList.remove("dark-color")),
                    -1 != n.indexOf("cursor-link") &&
                      (e.classList.remove("cursor-link"),
                      t.classList.remove("cursor-link"));
                }),
                $("body").on(
                  "mouseenter",
                  ".cursor-magnet, .btn-round",
                  function () {
                    const e = $(this),
                      n =
                        window.pageYOffset ||
                        document.documentElement.scrollTop;
                    (t.style.transition = "all .2s ease-out"),
                      (t.style.transform =
                        "translate(" +
                        e.offset().left +
                        "px, " +
          ...
          $(window).scroll(function () {
            i(),
              ...
              (function () {
                const e = $("body").height();
                let t =
                  (($(window).innerHeight() + $(window).scrollTop()) / e) * 100;
                t > 100 && (t = 100),
                  $(
                    ".clb-scroll-top:not(.clb-slider-scroll-top) .scroll-track"
                  ).css("width", t + "%");
              })(),
          ...
          $("body").on(
            "click keydown",
            ".clb-popup .clb-close, .clb-popup .subscribe-nothanks-btn",
            function (e) {
              e.preventDefault(e), l($(this).closest(".clb-popup"));
            }
          ),
          $(document).on("keydown", function (e) {
            var t = $(".clb-popup");
            ...
            n = setInterval(function () {
              $(".loader .loader-counter").html(t + "%"),
                ...
                101 == ++e &&
                  ...
                  $(".loader").fadeOut(300),
                  $(
                    ".main-section, .site-header, .clb-social, .purchase-theme"
                  ).addClass("visible"),
